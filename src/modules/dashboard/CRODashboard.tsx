...
function ExpertContainerIcon() {
  return (
    <svg width="192" height="192" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
      <mask id="cro-expert-mask" fill="white">
      ...
      <path d="M0 96C0 42.9807 42.9807 0 96 0C149.019 0 192 42.9807 192 96C192 149.019 149.019 192 96 192C42.9807 192 0 149.019 0 96Z" fill="url(#cro-expert-grad)"/>
      <path d="M0 96M192 96M192 96M0 96M96 0M192 96M96 192M0 96M96 192V191C43.533 191 1 148.467 1 96H0H-1C-1 149.572 42.4284 193 96 193V192ZM192 96H191C191 148.467 148.467 191 96 191V192V193C149.572 193 193 149.572 193 96H192ZM96 0V1C148.467 1 191 43.533 191 96H192H193C193 42.4284 149.572 -1 96 -1V0ZM96 0V-1C42.4284 -1 -1 42.4284 -1 96H0H1C1 43.533 43.533 1 96 1V0Z" fill="white" fillOpacity="0.1" mask="url(#cro-expert-mask)"/>
      ...
      <defs>
        <linearGradient id="cro-expert-grad" x1="37.5" y1="40" x2="155" y2="165.5" gradientUnits="userSpaceOnUse">
